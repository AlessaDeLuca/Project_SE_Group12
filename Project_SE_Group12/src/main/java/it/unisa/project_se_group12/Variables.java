 ...
 * @author PC MSI
 */
/*this class allows us to manage variables and the structure where they are stored. The
attributes of this class are the structure (another hash map) and a string that contains
all possible alphabetic variable*/
